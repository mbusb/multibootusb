            ...
            if sys.platform.startswith("linux"):
                if distro_syslinux_dir_path == "multibootusb":
                    ...
                    if subprocess.call(syslinux_version + syslinux_options + distro_syslinux_dir_path + ' ' + usb_device, shell=True) == 0:
                        ...
                        if os.geteuid() != 0:
                            if subprocess.call('echo ' + var.password + ' | sudo -S dd bs=440 count=1 conv=notrunc if=' + mbr_bin + ' of=' + usb_device[:-1], shell=True) == 0:
                    ...
                    if subprocess.call(syslinux_version + syslinux_options + distro_syslinux_dir_path + ' ' + usb_device, shell=True) == 0:
                        ...
                        if os.geteuid() != 0:
                            if subprocess.call('echo ' + var.password + ' | sudo -S dd if=' + usb_device + ' ' + 'of=' + var.distro_sys_install_bs + ' count=1', shell=True) == 0:
